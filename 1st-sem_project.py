...
def definitions():    #Definitions of the topics
    os.system('cls')
    print("Definitioins!")
    df = [
        "1 --- Print Statements",
    ...
    if pickdef == "1":
        ...
        os.system('cls')
        print("Conditional Statements are used to control the flow of a program.\n")
        ...
        return definitions()
def schoolworks():    #Activities and Code Challenges
    os.system('cls')
...
def heart():          #mini effort sa huli fully pro max
    ...
    time.sleep(3)     #para mabasa bago lumabas yung heart
